...
path = 'C:/Users/Nour/Desktop/ComputerVision/GTSRB/GTSRB/Train/resize'
...
x_train, x_validation, y_train, y_validation = train_test_split(x_train, y_train, test_size=ValidationRation, shuffle=True)
def preprocess(img):
...
model.save("C:/Users/Nour/Desktop/ComputerVision/GTSRB/GTSRB.h5")
